...
{
    public class ViewAllEquipmentMap : EntityTypeConfiguration<ViewAllEquipment>
    {
        public ViewAllEquipmentMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.Property(t => t.Connection1_Type)
                .HasMaxLength(200);

            // Table & Column Mappings
            this.ToTable("ViewAllEquipment");
            ...
            this.Property(t => t.Connection1_Type).HasColumnName("Connection1_Type");
        }
    }
}
