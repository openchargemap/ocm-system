var localisation_dictionary_hu ={
  ...
  "ocm": {
    ...
    "details": {
      ...
      "equipment": {
        "sectionTitle": "Berendezés adatai",
        "connectionType": "Csatlakozó típusa",
      ...
      "dataProvider": {
        ...
        "website": "Honlap",
        "providersReference": "Adatszolgáltató Ref"
      },
      "operator": {
        "sectionTitle": "Hálózat/üzemeltető",
        "operatorsReference": "Üzemeltető Ref"
      }
    },
    "search": {
      "sectionTitle": "Keresés",
      "locationInput": "Hely",
      "useMyLocation": "Keresés a közelemben",
      "distance": "Távolság",
      "chargingLevels": "Töltési sebesség",
      "minPowerKW": "Min. teljesítmény kW",
    ...
    "navigation": {
      ...
      "develop": {
        ...
        "api": "API",
        "htmlWidgets": "HTML widgetek",
        "examples": "Példák",
        "getInvolved": "Csatlakozz!",
        "code": "Nézd meg a kódot! (GitHub-on)",
        "translate": "Segíts lefordítani!"
      },
      "discuss": "Beszéljük meg!",
      "about": {
        "termsPrivacy": "Feltételek és adatvédelem",
        "contact": "Kapcsolat",
        "guidance": "Útmutató közreműködőknek"
      },
      "profile": {
        "sectionTitle": "Saját profil",
        "subscriptions": "Feliratkozásaim",
        "comments": "Észrevételeim",
        "uploads": "Feltöltéseim"
      }
    },
    "infoText": {
      "getInvolved": {
      ...
      "getStations": {
        ...
        "who": "Autógyártók, navigációs szoftver készítők, alkalmazásfejlesztők, weboldal tulajdonosok:",
        "what": "Elérheted és letöltheted a legfrissebb töltőpontok helyét a következő segítségével",
        "websiteOperators": "Ha weboldalt üzemeltetsz, és szeretnéd a látogatóidat ellátni a töltőpontok adataival, akkor",
        "embedMap": "illeszd be a térképet a weboldaladba!"
      },
      "supplyData": {
      ...
      "stats": {
        "locations": "Helyek",
        "locationSummary": "{totalStations} töltési pont {totalLocations} helyszínen"
      },
      "shortProjectSummary": "Az Open Charge Map egy cégek, alapítványok, fejlesztők és egyéb érdekelt felek által biztosított és támogatott nem kereskedelmi, non-profit szolgáltatás.",
      "getApp": "Töltsd le az alkalmazást!",
      "tip": "Tipp:",
      "searching": {
        "quickWay": "Ha csak gyorsan meg szeretnéd keresni a legközelebbi töltőpontot, akkor próbáld ki a",
    ...
    "reference": {
      "statusType": {
        ...
        "value_0": "Ismeretlen",
        "value_10": "Jelenleg elérhető (automatikus státusz)",
        "value_20": "Jelenleg használatban (automatikus státusz)",
        "value_30": "Átmenetileg nem elérhető",
        "value_50": "Működik",
        "value_75": "Részben működik",
        "value_100": "Nem működik",
        "value_150": "Tervezett",
        "value_200": "Nincs már ott (leszerelve)"
      },
      "operatorInfo": {
        "value_minus1": "(Nincs kiválasztva)",
      ...
      "levelType": {
        "value_minus1": "(Nincs kiválasztva)",
        "value_0": "(Ismeretlen)",
        "value_1": "Level 1: alacsony (2 kW alatt)",
        "value_2": "Level 2: közepes (2 kW felett)",
        "value_3": "Level 3: magas (40 kW felett)"
      },
      "supplyType": {
        "value_minus1": "(Nincs kiválasztva)",
        "value_0": "(Ismetelten)",
        "value_10": "AC (egy fázis)",
        "value_20": "AC (három fázis)",
        "value_30": "DC"
      }
    }
  }
