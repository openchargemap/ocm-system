...
var releaseVersion = "4.1.2_"+ moment().format('YYYYMMDD');
var indexFileName = "index.html";
var srcDir = "../";
var buildDir = "../../../../builds/webapp";
var targetList = ["web", "mobile/iOS", "mobile/Android", "mobile/WP7"];
...
var excludeFiles = [".gitignore", ".git", ".idea", "bin", "test", ".settings", "build",
    ".project", "README.md", "*psd", "*.psd", "*libs", "*.svg", "CordovaNotes.txt", "*.bat", ".svn"];
