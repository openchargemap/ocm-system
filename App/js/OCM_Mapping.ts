...
module OCM {
    ...
    export class Mapping {
        ...
        initMapGoogleNativeSDK(mapcanvasID: string) {
            ...
            if (console) console.log("Using Google Maps Native");
        ...
        showPOIListOnMapViewGoogleNativeSDK(mapcanvasID, poiList, appcontext, anchorElement, resultBatchID) {
            ...
            if (this.mapOptions.mapCentre != null) {
                ...
                var marker = new plugin.google.maps.Marker({
                    position: new plugin.google.maps.LatLng(this.mapOptions.mapCentre.coords.latitude, this.mapOptions.mapCentre.coords.longitude),
            ...
            if (poiList != null && poiList.length > 0) {
                ...
                if (console) console.log("Skipping setting bounds");
            }
            ...
            if (this.enableLogging && console) console.log("showPOIList: refreshing map layout");
            this.map.refreshLayout();
        ...
        showPOIListOnMapViewGoogle(mapcanvasID, poiList, appcontext, anchorElement, resultBatchID) {
            ...
            if (!this.mapsInitialised) {
                if (this.enableLogging && console) console.log("showPOIList; cannot show google map, not initialised.");
                return;
            }
        ...
        refreshMapView(mapCanvasID: string, mapHeight: number, poiList: Array<any>, searchPos: any): boolean {
            ...
            if (this.mapOptions.mapAPI == "googlenativesdk") {
                ...
                if (this.enableLogging && console) console.log("Refreshing map using API: googlenativesdk");
                ...
                var isAvailable = plugin.google.maps.Map.isAvailable(function (isAvailable, message) {
                    if (isAvailable) {
                        ...
                        if (console) console.log("Native Maps not available");
                    }
                    return isAvailable;
                });
            ...
            if (this.mapOptions.mapAPI == "google") {
                ...
                if (this.enableLogging && console) console.log("Refreshing map using API: google");
        ...
        hideMap() {
            if (this.mapOptions.mapAPI == "googlenativesdk") {
                if (this.enableLogging && console) console.log("Debug: Hiding Map");
        ...
        showMap() {
            if (this.mapOptions.mapAPI == "googlenativesdk") {
                if (this.enableLogging && console) console.log("Debug: Showing Map");
