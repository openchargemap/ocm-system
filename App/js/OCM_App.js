...
OCM_App.prototype.setupUIActions = function () {
    ...
    if (this.launchMapOnStart) {
        ...
        if (this.ocm_ui.mappingManager.mapAPIReady) {
            ...
            Object.observe(this.ocm_ui.mappingManager, function (changes) {
...
OCM_App.prototype.refreshMapView = function () {
    ...
    if (!this.mapLaunched) {
        ...
        if (console)
            console.log("adjusted map height:" + mapHeight);
    }
...
OCM_App.prototype.setMapFocus = function (hasFocus) {
    if (hasFocus) {
